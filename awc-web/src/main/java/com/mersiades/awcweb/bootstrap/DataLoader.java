    ...
    public void run(String... args) throws Exception {
        ...
        for (Game game : games) {
            ...
            for (MockDiscordUser mockUser : mockUsers) {
                GameRole gameRole;
                if (!hasSetMC) {
                    gameRole = gameService.addGameRole(mockUser.getId(), game.getTextChannelId(), GameRole.Role.MC);
                    hasSetMC = true;
                } else {
                    gameRole = gameService.addGameRole(mockUser.getId(), game.getTextChannelId(), GameRole.Role.PLAYER);
                }
